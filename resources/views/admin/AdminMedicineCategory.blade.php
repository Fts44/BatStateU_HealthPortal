        ...
        <div class="section" >
            <div class="card" id="cardTable">
                <div class="card-body px-4">
                    <h5 class="card-title">Medicine Category</h5>
                        ...
                        @foreach($medicine_categories as $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger btn-sm" href="{{ route('AdminInventoryDeleteMedicineCategory', ['mc_id' => $category->mc_id ]) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_title">Medicine Category</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form id="form" action="{{ route('AdminInventoryMedicineCategory') }}" method="POST">
                    <div class="modal-body">       
                        @csrf
                        <div class="form-control border-0">
                            <label for="mt_name" class="col-lg-12">Name:</label>
                            <input class="form-control mt-2" type="text" id="mc_name" name="mc_name" placeholder="Medicine Category" value="{{ old('mc_name') }}">
    ...
    <script>
        $(document).ready(function(){
            ...
            table.on('click', '#Update', function(){
                ...
                console.log(data);
                $('#mc_name').val(data[1]);
                $('#form').attr('action', "{{ url('admin/inventory/medicine/category/update/') }}"+"/"+data[0]);
